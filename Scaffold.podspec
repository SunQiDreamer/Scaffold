#
#  Be sure to run `pod spec lint Scaffold.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "孙琦" => "993473797@qq.com" }
  # Or just: spec.author    = "孙琦"
  # spec.authors            = { "孙琦" => "993473797@qq.com" }
  # spec.social_media_url   = "https://twitter.com/孙琦"
